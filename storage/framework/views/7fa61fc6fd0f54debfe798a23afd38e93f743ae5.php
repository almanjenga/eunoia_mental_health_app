...
<body>
              ...
              <div class="col-md-7">
                <div class="detail-box">
                  <div>
                    ...
                    <div class="btn-box">
                      <a href="<?php echo e(route('community')); ?>" class="btn-1" id="getStartedBtn">
                        Access Chats
                      </a>
                    </div>
                    <div class="btn-box">
                      <a href="<?php echo e(route('appointments')); ?>" class="btn-1" id="getStartedBtn">
  ...
  </html><?php /**PATH C:\xampp3\htdocs\MentalHealthApp\mental_health\resources\views/professional.blade.php ENDPATH**/ ?>