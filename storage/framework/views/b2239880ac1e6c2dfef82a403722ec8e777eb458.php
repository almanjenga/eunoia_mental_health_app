                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4" id="chatRooms">
                        ...
                        <div class="p-4 bg-gray-200 rounded-lg">
                            ...
                            <p class="text-sm text-gray-600 mt-2">Join this chat room for anxiety-related support.</p>
                             <a href="<?php echo e(route('chatrooms.show', ['room' => 'anxiety-support'])); ?>" class="block mt-2 text-sm text-blue-600">Join Chat Room</a>
                        </div>
                        ...
                        <div class="p-4 bg-gray-200 rounded-lg">
                            ...
                            <a href="<?php echo e(route('chatrooms.show', ['room' => 'depression-support'])); ?>" class="block mt-2 text-sm text-blue-600">Join Chat Room</a>
                        </div>
                        <div class="p-4 bg-gray-200 rounded-lg">
...
<?php endif; ?>
<?php /**PATH C:\xampp3\htdocs\MentalHealthApp\mental_health\resources\views/features/community.blade.php ENDPATH**/ ?>