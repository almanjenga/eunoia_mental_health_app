...
<body>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo e(route('profile.show')); ?>"> User Profile</a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-7">
                <div class="detail-box">
                  <div>
                    <h1>
                      Welcome <?php echo e(Auth::user()->name); ?> <br>
                      <span>
  ...
  <div class="body_bg layout_padding">
    <section class="features" id="services">
      <div class="container1">
        ...
        <a href="<?php echo e(route('game.breathing')); ?>" class="feature-link">
          ...
          <a href="<?php echo e(route('community')); ?>" class="feature-link">
          ...
          <a href="<?php echo e(route('mental_health_professionals')); ?>" class="feature-link">
  ...
  </html><?php /**PATH C:\xampp3\htdocs\MentalHealthApp\mental_health\resources\views/dashboard.blade.php ENDPATH**/ ?>