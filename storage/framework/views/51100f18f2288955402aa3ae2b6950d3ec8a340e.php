...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => ''.e(route('redirects')).'','active' => request()->routeIs('redirects')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('redirects')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('redirects'))]); ?>
                        <?php echo e(__('Home')); ?>
...
<?php /**PATH C:\xampp3\htdocs\MentalHealthApp\mental_health\resources\views/navigation-menu.blade.php ENDPATH**/ ?>